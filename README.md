...
To maintain a clean codebase, the project is modularized into five distinct Python files:
...
* **`main.py`**: *The master execution loop.* The entry point for the batch simulation. It generates the scenario matrix, runs the optimization algorithm, safely saves the `.png` plots to disk, and outputs the final statistical metrics to a text file.
